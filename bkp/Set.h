...
namespace DataStructure
{
	...
	public:
		...
		virtual Type get(size_t index) const { return TypeC<Type>::get(index); }
		
		virtual void set(Type value, size_t index)
		{
		...
		virtual void insert(Type value, size_t index)
		{
			if(!this->contains(value) && index <= this->getSize())
		...
		virtual void clear(){ TypeC<Type>::clear(); }
		
		//conversão para texto
		virtual std::string strFormat(char c='{'){ return TypeC<Type>::strFormat(c); }
