...
namespace DataStructure
{
	...
	public:
		...
		{
			this->head = new Node<Type>(); //nó inicial
		...
		Type& operator[](size_t index){ return this->nthNode(index)->value; }
		...
		std::string strFormat(char c=' '){ return Container<Type>::strFormat(c); }
